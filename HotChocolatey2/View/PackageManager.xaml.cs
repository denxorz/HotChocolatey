...
namespace HotChocolatey.View
{
    public partial class PackageManager : UserControl
    {
        ...
        private async void OnSearch(object sender, SearchEventArgs e)
        {
            ...
            await (DataContext as HotChocolatey2.ViewModel.MainWindowViewModel).Search(e);
        }

        private void OnDataContextChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            // TODO : Not really neat, but good enough for now
            (DataContext as HotChocolatey2.ViewModel.MainWindowViewModel).ClearSearchBox = () => SearchTextBox.Clear();
            ScrolledToBottom += (DataContext as HotChocolatey2.ViewModel.MainWindowViewModel).OnScrolledToBottom;
        }
    }
}
